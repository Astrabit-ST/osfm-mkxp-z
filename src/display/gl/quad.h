...
struct Quad {
  ...
  template <typename V> static void setPosRect(V *vert, const FloatRect &r) {
    int i = 0;
  ...
  template <typename V> static void setTexRect(V *vert, const FloatRect &r) {
    int i = 0;
  ...
  template <typename V>
  static int setTexPosRect(V *vert, const FloatRect &tex,
                           const FloatRect &pos) {
    setPosRect(vert, pos);
    setTexRect(vert, tex);
  ...
  template <typename V> static void setColor(V *vert, const Vec4 &c) {
    for (int i = 0; i < 4; ++i)
      vert[i].color = c;
  }
